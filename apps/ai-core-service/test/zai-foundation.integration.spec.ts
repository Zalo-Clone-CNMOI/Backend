...
// Integration test that crosses the ai-core-service ↔ chat-service boundary.
// Imports AiMessageConsumer directly to verify the chat.ai.message → chat.message.created
