...
export const AuthApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    authQrGenerate: async (
      qrGenerateDto: QrGenerateDto,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
    ...
    authQrStatus: async (
      ...
      const localVarPath = `/auth/qr/status/{sessionId}`.replace(
        `{${'sessionId'}}`,
  ...
  return {
    ...
    async authQrConfirm(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<AuthQrConfirm200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.authQrConfirm(
        qrConfirmDto,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authQrConfirm']?.[
    ...
    async authQrGenerate(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<QrSessionResponseDto>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.authQrGenerate(
        qrGenerateDto,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authQrGenerate']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async authQrReject(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<AuthQrReject200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.authQrReject(
        qrRejectDto,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authQrReject']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async authQrStatus(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<QrStatusResponseDto>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.authQrStatus(
        sessionId,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authQrStatus']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async refreshToken(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RefreshTokenResponseDto>
    > {
...
export const AuthApiFactory = function (
  ...
  return {
     ...
     */
    authQrConfirm(
      requestParameters: AuthApiAuthQrConfirmRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<AuthQrConfirm200Response> {
      return localVarFp
        .authQrConfirm(requestParameters.qrConfirmDto, options)
     ...
     */
    authQrGenerate(
      requestParameters: AuthApiAuthQrGenerateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<QrSessionResponseDto> {
      return localVarFp
        .authQrGenerate(requestParameters.qrGenerateDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Mobile user rejects QR login after scanning.
     ...
     */
    authQrReject(
      requestParameters: AuthApiAuthQrRejectRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<AuthQrReject200Response> {
      return localVarFp
        .authQrReject(requestParameters.qrRejectDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Poll the status of a QR login session. Use this as fallback when WebSocket is unavailable.
     ...
     */
    authQrStatus(
      requestParameters: AuthApiAuthQrStatusRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<QrStatusResponseDto> {
      return localVarFp
        .authQrStatus(requestParameters.sessionId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Returns access and refresh tokens upon successful authentication
    ...
    login(
      ...
      return localVarFp
        .login(requestParameters.loginDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Invalidates the refresh token
    ...
    logout(
      ...
      return localVarFp
        .logout(requestParameters.logoutDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Uses refresh token to get new access token
    ...
    register(
      ...
      return localVarFp
        .register(requestParameters.registerDto, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Resets the user password after verifying Firebase token
    ...
    resetPassword(
      ...
      return localVarFp
        .resetPassword(requestParameters.resetPasswordDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
 ...
 * @export
 */
export const DeviceTokensApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
    ...
    deleteDeviceToken: async (
      ...
      const localVarPath = `/device-tokens/{tokenId}`.replace(
        `{${'tokenId'}}`,
...
export const DeviceTokensApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    DeviceTokensApiAxiosParamCreator(configuration);
  return {
    /**
     * Remove all device tokens for the current user
     * @summary Delete all device tokens
     ...
     * @throws {RequiredError}
     */
    async deleteAllDeviceTokens(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<DeleteAllDeviceTokens200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteAllDeviceTokens(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DeviceTokensApi.deleteAllDeviceTokens']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async deleteDeviceToken(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<DeleteDeviceToken200Response>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteDeviceToken(tokenId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DeviceTokensApi.deleteDeviceToken']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getUserDeviceTokens(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<DeviceTokenResponseDto>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getUserDeviceTokens(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DeviceTokensApi.getUserDeviceTokens']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async registerDeviceToken(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<DeviceTokenResponseDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.registerDeviceToken(
          registerDeviceTokenDto,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DeviceTokensApi.registerDeviceToken']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const DeviceTokensApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
     ...
     */
    deleteDeviceToken(
      requestParameters: DeviceTokensApiDeleteDeviceTokenRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<DeleteDeviceToken200Response> {
      return localVarFp
        .deleteDeviceToken(requestParameters.tokenId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Retrieve all active device tokens for the current user
     ...
     */
    registerDeviceToken(
      requestParameters: DeviceTokensApiRegisterDeviceTokenRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<DeviceTokenResponseDto> {
      return localVarFp
        .registerDeviceToken(requestParameters.registerDeviceTokenDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class DeviceTokensApi extends BaseAPI {
  ...
  public deleteAllDeviceTokens(options?: RawAxiosRequestConfig) {
    return DeviceTokensApiFp(this.configuration)
      .deleteAllDeviceTokens(options)
      .then((request) => request(this.axios, this.basePath));
  }
  ...
  return {
    ...
    async getMyProfile(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UserProfileResponseDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMyProfile(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['UsersApi.getMyProfile']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getPublicProfile(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PublicUserResponseDto>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getPublicProfile(userId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['UsersApi.getPublicProfile']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async searchUsers(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<PaginatedUserSearchResultDto>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['UsersApi.searchUsers']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['UsersApi.updateMyProfile']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const UsersApiFactory = function (
  ...
  return {
     ...
     */
    getPublicProfile(
      requestParameters: UsersApiGetPublicProfileRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PublicUserResponseDto> {
      return localVarFp
        .getPublicProfile(requestParameters.userId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Search for users with pagination
     ...
     */
    searchUsers(
      requestParameters: UsersApiSearchUsersRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<PaginatedUserSearchResultDto> {
      return localVarFp
        .searchUsers(
     ...
     */
    updateMyProfile(
      requestParameters: UsersApiUpdateMyProfileRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<UserProfileResponseDto> {
      return localVarFp
        .updateMyProfile(requestParameters.updateProfileDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
